...
#Youtube : Mr.DinXploit
#Author    :Mr.DinXploit404
#Tool Unfaedah :v
...
clear
            ...
            echo $pur"  ║ ║║║║╠╣ ╠═╣║╣  ║║╠═╣╠═╣"
            echo $pur"  ╚═╝╝╚╝╚  ╩ ╩╚═╝═╩╝╩ ╩╩ ╩"
            echo $mer"  ×××Tool Unfaedah | Mr.DinXploit $st"

lagi=1
while [ $lagi -lt 6 ];
do
echo""
echo $cy"1. Sadap WA work:v ";
echo $pur"====================]" 
...
echo $cy  " <Kemarin> "
echo ""
echo $pu " +6282353355724: woy $cy[09:22]"
echo $i " Me : Apaan Dim? $cy[09:22]"
echo $pu " +6282353355724: Besok Masuk Jam Brp? $cy[09:23]"
echo $i " Me : Ya seperti biasa jam 7 $cy[09.23]"
echo $pu " +6282353355724: Bareng kita berangkat ya, gua jemput lu besok $cy[09.24]"
echo $i " Me : Gua maless dah sekolah besok, dirumah ga ada org ortu gua pergi besok $cy[09:24]"
echo $pu " +6282353355724: Ya udh gak usah masuk kita besok $cy[09:25]"
echo $i " Me : Ashiiiaaap.. Main dirumah gua aja besok $cy[09:26]"
echo $pu " +6282353355724: Oke Oke $cy[09:36]"
echo $pu " +6282353355724: Eh VC kuy.. $cy[15:06]"
echo $i " Me : Hmm.. kuy lah.. lagi bosen gua $cy[15:06]"
echo $pu " +6282353355724: Oke dah, gua mau off, besok gua kerumah lu $cy[17:05]"
echo $i " Me : Ok.. Besok kita senang-senang.. $cy[17:22]"
echo $pu " +6282353355724: Wkwk.. ashiapp.. Lope you 😘😘 $cy[17:22]"
exit
;;
